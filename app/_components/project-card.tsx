...
export function ProjectCard({ project, className = "", isFeatured = false }: ProjectCardProps) {
    ...
    return (
        <div
            className={`glass-premium card-glow-border group relative flex flex-col h-full rounded-3xl p-6 transition-all duration-500 hover:scale-[1.02] hover:-translate-y-1 active:scale-[0.97] dark:hover:border-zinc-600/50 ${gradientClass} ${className}`}
        >
